...
However, complex data such as objects and arrays seems to be passed by reference, because if we change the contents of the object we are changing the contents of original object. Example:
