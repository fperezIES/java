...
Then, if number is `3.14159`, the output would be  <code>The number is &nbsp;&nbsp;3.142</code>. 5 Characters, including the point, and 3 fraction digits. Please note the rounding.
...
System.out.printf("The number is %.3f", number);
```
Then, if number is `3.14159`, the output would be  <code>The number is &nbsp;&nbsp;3.14</code>. 5 Characters, including the point, and 3 fraction digits.
